...
Við notum **CLI** (_Command Line Interface_) forrit til að búa til vefþróunarsvæði, 
<details>
  <summary>nánari upplýsingar um aðgerðir sem hægt er að framkvæma í CLI eru hér:</summary>
...
> Ekki nota **íslenska** stafi eða hafa bil í skjala- og möppuheitum!
