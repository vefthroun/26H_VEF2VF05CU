...
### 4. CRUD
1. [CRUD. Create, Read, Update, Delete](CRUD.md)

---

#### Aukaefni

1. WYSIWYG HTML editor has the ability to convert HTML text area fields or other HTML elements to editor instances. WYSIWYG is an acronym for "what you see is what you get." [Flask CKEditor](https://flask-ckeditor.readthedocs.io/en/latest/)
   * [How To Add A Rich Text Editor and Basic usage](https://www.youtube.com/watch?v=5jnAnnxZGQQ&ab_channel=Codemy.com) _myndband_
1. [Flask WTF form](Flask_WTF.md)
